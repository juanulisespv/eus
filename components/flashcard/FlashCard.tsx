            ...
            <div className="space-y-4 overflow-y-auto flex-1 pr-1">
              ...
              {currentExample && (
                <div className="bg-zinc-950/60 p-4 rounded-2xl border border-white/[0.05]">
                  ...
                  <p className="font-bold text-zinc-100 text-lg sm:text-xl mt-1 leading-snug">{currentExample.sentence_eu}</p>
                  <p className="text-sm sm:text-base text-zinc-400 mt-1.5 leading-relaxed">{currentExample.sentence_es}</p>
                </div>
              )}
